...
def provision_cluster():
    try:
        ...
        configure_security_groups(cluster_details["hsm_cluster_sg_name"])

        # test setup only..
        """cluster_details = {"hsm_cluster_id": "cluster-jsh...",
                           "subnet_details": {"azs": ["eu-west-2a"]}}"""

        hsm_services.create_hsm(cluster_details["hsm_cluster_id"], cluster_details["subnet_details"]["azs"][0])
...
def configure_security_groups(hsm_cluster_sg_name):
    ...
    hsm_cluster_sg_id = ec2_services.get_sg_id_by_name(hsm_cluster_sg_name)
